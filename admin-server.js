        ...
        <body>
            <div class="container">
                ...
                <div class="filter-section">
                    ...
                    <input type="text" id="searchInput" placeholder="Search by email, name, or provider...">
            ...
            <script>
                ...
                function exportCSV() {
                    let csv = 'Timestamp,Type,Email,Name,Phone,Provider,User Agent\\n';
...
app.listen(PORT, () => {
    console.log(`Admin server running on http://172.15.1.21:${PORT}/admin`);
    console.log(`API endpoint: http://172.15.1.21:${PORT}/admin`);
